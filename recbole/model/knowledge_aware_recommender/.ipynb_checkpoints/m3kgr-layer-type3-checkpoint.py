...
class M3KGR(KnowledgeRecommender):
    ...
    def __init__(self, config, dataset):
        ...
        self.projection_head_multi_1.append(torch.nn.Linear(self.multimodal_size, self.multimodal_size, bias=False))
        self.projection_head_multi_1.append(torch.nn.BatchNorm1d(self.multimodal_size, eps=1e-12, affine=affine))
        self.projection_head_multi_1.append(torch.nn.Linear(self.multimodal_size, self.embedding_size, bias=False))
        ...
        self.projection_head_multi_2.append(torch.nn.Linear(self.multimodal_size, self.multimodal_size, bias=False))
        self.projection_head_multi_2.append(torch.nn.BatchNorm1d(self.multimodal_size, eps=1e-12, affine=affine))
        self.projection_head_multi_2.append(torch.nn.Linear(self.multimodal_size, self.embedding_size, bias=False))
